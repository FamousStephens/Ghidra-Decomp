...
void main(int param_1,int param_2,int param_3,int param_4,
...
int switch_large(int param_1,int param_2,int param_3,int param_4)
...
int switch_small(int param_1,int param_2,int param_3,int param_4)
